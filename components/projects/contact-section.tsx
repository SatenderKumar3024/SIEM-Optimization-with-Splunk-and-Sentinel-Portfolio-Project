...
import { Linkedin, Twitter, Calendar, LinkIcon, Mail, Phone } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="bg-[#1a1a24]/80 border-[#6e3adc]/20 backdrop-blur-sm rounded-xl shadow-[0_8px_30px_rgb(110,58,220,0.1)]">
              ...
              <TabsContent value="general">
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="text-xs text-white/60 text-center mt-4 leading-relaxed">
        ...
        <Card className="bg-[#1a1a24]/80 border-[#6e3adc]/20 backdrop-blur-sm rounded-xl shadow-[0_8px_30px_rgb(110,58,220,0.1)]">
          <CardContent className="p-6">
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <h4 className="font-medium text-white/90 border-b border-[#6e3adc]/20 pb-2">Contact Information</h4>
              ...
              <div className="space-y-4">
                <h4 className="font-medium text-white/90 border-b border-[#6e3adc]/20 pb-2">Connect With Me</h4>
              ...
              <div className="pt-4">
                <Button
                  variant="outline"
                  className="w-full border-[#6e3adc]/30 hover:bg-[#6e3adc]/20 hover:border-[#6e3adc]/50 text-white"
                >
                  Schedule a Call
                </Button>
              </div>
